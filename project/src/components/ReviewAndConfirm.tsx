    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between w-full max-w-2xl mb-6">
                ...
                <h1 className="text-2xl font-bold text-emerald-700">Select Item</h1>
                ...
                <div className="mt-4">
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            ...
                            // Prevent NaN (if input is cleared)
                        ...
                        className="w-44 border border-gray-400 rounded-full px-4 py-2 focus:outline-none focus:border-emerald-300 "
                    />
                    <p className="text-gray-500 text-sm mt-1">You can also choose the full quantity.</p>
                </div>
