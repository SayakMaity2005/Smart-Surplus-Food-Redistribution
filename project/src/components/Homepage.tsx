          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                {index < 2 && (
                  <ArrowRight className="w-8 h-8 text-gray-300 mx-auto mt-6 hidden md:block" />
                )}
              </motion.div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <UserPlus className="w-12 h-12 text-emerald-600 mb-6" />
            ...
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <Handshake className="w-12 h-12 text-orange-600 mb-6" />
